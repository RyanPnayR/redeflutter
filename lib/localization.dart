import "package:redeflutter/presentation/common/platform_alerts.dart";
...
final localizationsDelegates = <LocalizationsDelegate>[
  const RedeappLocalizationsDelegate(),
  GlobalMaterialLocalizations.delegate,
  GlobalWidgetsLocalizations.delegate,
  const FallbackCupertinoLocalisationsDelegate()
];

class RedeappLocalizations {
  RedeappLocalizations(this.locale);

  final Locale locale;

  static RedeappLocalizations of(BuildContext context) {
    return Localizations.of<RedeappLocalizations>(
        context, RedeappLocalizations);
  }
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    "de": {
      ...
      "platform_alert_access_body":
          "Damit du diese Funktion nutzen kannst benötigen wir Zugriff auf deine {RESOURCE}",
    ...
    "pt_BR": {
      ...
      "channel_form_topic_exists": "Já existe um canal com este nome.",
      "channel_form_select_members_error":
      ...
      "event_form_purpose_helper":
          "De forma sucinta, diga a finalidade do evento",
      ...
      "platform_alert_access_body":
          "Para este recurso funcionar, o app precisa do acesso a {RESOURCE}",
      "platform_alert_access_resource_camera": "camera",
      "platform_alert_access_resource_photos": "fotos",
...
class RedeappLocalizationsDelegate
    extends LocalizationsDelegate<RedeappLocalizations> {
  const RedeappLocalizationsDelegate();

  @override
  bool isSupported(Locale locale) =>
      ["en", "de", "pt_BR"].contains(locale.languageCode);

  @override
  Future<RedeappLocalizations> load(Locale locale) {
    return SynchronousFuture<RedeappLocalizations>(
        RedeappLocalizations(locale));
  }

  @override
  bool shouldReload(RedeappLocalizationsDelegate old) => false;
}
